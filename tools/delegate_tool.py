...
def _strip_blocked_tools(toolsets: List[str]) -> List[str]:
    ...
    cleaned = [t for t in toolsets if t not in blocked_toolset_names]
    if "skills_readonly" not in cleaned:
        cleaned.append("skills_readonly")
    return cleaned
...
DELEGATE_TASK_SCHEMA = {
    ...
    "description": (
        ...
        "- Subagents CAN read skills (skills_list, skill_view) but not create/edit them.\n"
